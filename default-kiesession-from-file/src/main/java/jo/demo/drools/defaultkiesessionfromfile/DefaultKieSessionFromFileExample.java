package jo.demo.drools.defaultkiesessionfromfile;
...
public class DefaultKieSessionFromFileExample {
    ...
    private static Object createMessage(KieContainer kContainer, String name, String text) {
        Object o = null;
        try {
            Class cl = kContainer.getClassLoader().loadClass("jo.demo.drools.defaultkiesession.Message");
    ...
    public static File getFile(String exampleName) {
        File folder = new File("drools-demo").getAbsoluteFile();
