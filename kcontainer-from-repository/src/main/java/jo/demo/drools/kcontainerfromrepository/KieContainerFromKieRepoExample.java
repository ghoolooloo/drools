...
public class KieContainerFromKieRepoExample {
    ...
    public void go(PrintStream out) {
        ...
        KieContainer kContainer = ks.newKieContainer(ks.newReleaseId("jo.demo.drools", "named-kiesession", "1.0.0"));
    ...
    private static Object createMessage(KieContainer kContainer, String name, String text) {
        Object o = null;
        try {
            Class cl = kContainer.getClassLoader().loadClass("jo.demo.drools.namedkiesession.Message");
